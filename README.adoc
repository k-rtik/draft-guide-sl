...
Make sure that the `id` of your [hotspot=googleOIDCLogin]`oauth2Login` configuration matches the redirect URL (if you set the `id` to `googleOIDCLogin`, the redirect URL must end with `.../googleOIDCLogin`).
