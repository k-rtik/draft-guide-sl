...
Instead of securing your `Hello` service by implementing your own authentication service,
...
By the end of this guide, you will secure your `Hello` service with three social media login choices:
...
users that are authenticated using social media login to access your `Hello` service.
